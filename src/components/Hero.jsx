        ...
        <div className="w-full lg:w-1/2">
          <div className="flex flex-col items-center lg:items-start">
            ...
            <motion.span 
             ...
             initial="hidden"
             animate="visible"
            className="bg-gradient-to-r from-gray-600 via-gray-800 to-black bg-clip-text text-3xl tracking-tight text-transparent">
              Software Engineer
            </motion.span>
        ...
        <div className="w-full lg:w-1/2 lg:p-8 relative">
          ...
          <div className="flex justify-center items-center relative z-10">
            ...
            transition={{duration:1,delay:1.2}}
              src={profilePic}
              alt="Profile"
              className="w-80 h-80 lg:w-96 lg:h-96 object-cover shadow-lg rounded-lg"
            />
          </div>
        </div>
      </div>
